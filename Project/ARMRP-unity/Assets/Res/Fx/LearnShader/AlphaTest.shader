...
Shader "AlphaTest"
{
	Properties
	{
		...
		[ASEBegin]_AlphaTest("AlphaTest", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_AlphaTest = IN.ase_texcoord3.xy * _AlphaTest_ST.xy + _AlphaTest_ST.zw;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( tex2D( _MainTexture, uv_MainTexture ) * _Color ).rgb;
				float Alpha = ( tex2D( _AlphaTest, uv_AlphaTest ).a * _Color.a );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_AlphaTest = IN.ase_texcoord2.xy * _AlphaTest_ST.xy + _AlphaTest_ST.zw;
...
/*ASEBEGIN
Version=18912
2683;149;1187;758;1145.649;261.7535;1;True;True
Node;AmplifyShaderEditor.ColorNode;6;-730.045,315.8827;Inherit;False;Property;_Color;Color;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;5;-757.8925,39.38296;Inherit;True;Property;_AlphaTest;AlphaTest;0;0;Create;True;0;0;0;False;0;False;-1;a55fb3c0768e249f0b52a465d44dced4;f52b43656a88503418cc22e3e21f18d5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-566.5511,-212.3382;Inherit;True;Property;_MainTexture;MainTexture;1;0;Create;True;0;0;0;False;0;False;-1;None;15916210eab6c9d4eba519ad81b97de3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-240.3702,32.63914;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;-245.9859,149.714;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=271752BD5D2DD9BCEF1927C627893A80ACBADC9A