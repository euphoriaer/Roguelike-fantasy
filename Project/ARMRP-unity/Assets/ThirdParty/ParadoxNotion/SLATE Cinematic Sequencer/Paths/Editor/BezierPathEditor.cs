...
namespace Slate
{
    ...
    public class BezierPathEditor : Editor
    {
        ...
        void DrawPointSceneGUI(BezierPoint point, int index) {
            ...
            var fmh_92_52_638221018060113829 = Quaternion.identity; Handles.FreeMoveHandle(point.position, pointGUISize, Vector3.zero, Handles.RectangleHandleCap);
            ...
            if ( point.handleStyle != BezierPoint.HandleStyle.None ) {
                var fmh_101_78_638221018060138871 = Quaternion.identity; var newGlobal1 = Handles.FreeMoveHandle(point.globalHandle1, HandleUtility.GetHandleSize(point.globalHandle1) * 0.075f, Vector3.zero, Handles.CircleHandleCap);
                ...
                var fmh_109_78_638221018060141933 = Quaternion.identity; var newGlobal2 = Handles.FreeMoveHandle(point.globalHandle2, HandleUtility.GetHandleSize(point.globalHandle2) * 0.075f, Vector3.zero, Handles.CircleHandleCap);
